    ...
    <section id="token" className="py-20 bg-gradient-to-br from-black via-neutral-900 to-black">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          {/* Token Utility Card (Replaces Private Sale Card) */}
          <div className="bg-black/40 backdrop-blur-sm border border-yellow-500/10 rounded-xl p-8">
            <div className="flex items-center mb-6">
              <Layers className="w-8 h-8 text-yellow-500 mr-4" />
            ...
            <ul className="space-y-4 text-neutral-300">
              <li className="flex items-start gap-2">
                ...
                <span>Access premium platform features and tools.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-yellow-500">•</span>
                <span>Earn staking rewards by locking your tokens.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-yellow-500">•</span>
                <span>Governance voting on ecosystem proposals.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-yellow-500">•</span>
                <span>Pay transaction fees with discounted rates.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-yellow-500">•</span>
                <span>Use in marketplace for goods/services.</span>
              </li>
            </ul>
          </div>
        </div>
