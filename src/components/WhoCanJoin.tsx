...
const UserTypeCard: React.FC<UserTypeCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <button className="mt-8 w-full py-3 bg-gradient-to-r from-yellow-500 to-amber-400 text-black rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-yellow-500/20 font-medium">
        Join Now
      </button>
    </div>
  );
