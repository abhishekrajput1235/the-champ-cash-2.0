...
//             <a 
//               href="#join"
//               className="px-8 py-4 bg-gradient-to-r from-yellow-500 to-amber-400 text-black rounded-full font-medium transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-yellow-500/20"
//             >
//               Join the Revolution
//             </a>
//             <a
//               href="#about"
//               className="px-8 py-4 bg-transparent border-2 border-yellow-500/50 text-yellow-500 rounded-full font-medium transition-all duration-300 flex items-center justify-center hover:bg-yellow-500/10"
//             >
