...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Connect your wallet → enter BNB → buy tokens → done.'
  },
  {
  ...
  {
    question: 'Can I withdraw BNB?',
    answer: 'No, once you buy tokens, BNB is locked into the system. Owner can only withdraw for project use.'
  }
];
